                            ...
                            <tbody>
                                @foreach ($data as $dt)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->jml_balita_diukur }}</p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->jml_balita_stunting }}</p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->persentase }}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
