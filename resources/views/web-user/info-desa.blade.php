            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <h5 class="mb-0">{{ __('Desa UCI (Universal Child Immunization)') }}</h5>
                        <div class="dropdown">
                            ...
                            <tbody>
                                @foreach ($data as $dt)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->kabupaten_kota->jml_desa }}</p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->jml_desa_uci }}</p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1" id="persen" name="persen">{{ round(($dt->jml_desa_uci / $dt->kabupaten_kota->jml_desa)*100 , 1) }}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
