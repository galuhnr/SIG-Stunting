                            ...
                            <tbody>
                                @foreach ($data as $dt)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->jml_bayi }}</p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ $dt->jml_diberi_asi }}</p>
                                        </td>
                                        <td class="text-center">
                                            <p class="text-xs font-weight-bold my-1">{{ round(($dt->jml_diberi_asi / $dt->jml_bayi)*100 , 1) }}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
